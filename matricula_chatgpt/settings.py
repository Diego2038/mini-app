"""
Django settings for matricula_chatgpt project.
...
SECRET_KEY = 'django-insecure-mb+8@p&0urna7&do-q$@u@_%qe08!pips^th3*qxmcx^f0g%y+'
...
ROOT_URLCONF = 'matricula_chatgpt.urls'
...
WSGI_APPLICATION = 'matricula_chatgpt.wsgi.application'
